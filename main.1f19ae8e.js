...
var CONTRACT_NAME = undefined || 'chairul-arsa.testnet';
/* TODO: fill this in! */
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat(undefined, "/.near/validator_key.json"),
...
function signedInFlow() {
  ...
  document.getElementById('account-id').innerText = window.accountId; // Displaying current account name.

  document.getElementById('account-id-2').innerText = window.accountId; // Adding an event to a say-hi button.

  document.getElementById('say-hi').addEventListener('click', function () {
    // We call say Hi and then update who said Hi last.
    window.location.replace("/2dcity/game.html?near=" + window.accountId);
  }); // Adding an event to a say-hi button.

  document.getElementById('say-hi-2').addEventListener('click', function () {
    // We call say Hi and then update who said Hi last.
    window.location.replace("/2dcity/game.html?near=" + window.accountId);
  ...
  document.getElementById('sign-out-2').addEventListener('click', function (e) {
    e.preventDefault();
    walletAccount.signOut(); // Forcing redirect.
